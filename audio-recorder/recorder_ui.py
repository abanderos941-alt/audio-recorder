...
class RecorderApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        self._btn_mic_mute = tk.Button(frm_ctrl, text='Откл. микрофон',
                                        command=self._toggle_mic_mute, state='disabled',
                                        bg='#ffe0e0', activebackground='#ffc0c0',
                                        relief='raised', bd=1)
        self._btn_mic_mute.pack(side='left', padx=(10, 0), ipadx=8, ipady=5)
        ttk.Button(frm_ctrl, text='Открыть папку', command=self._open_folder).pack(side='right')
    ...
    def _toggle_mic_mute(self):
        ...
        if muted:
            self._btn_mic_mute.config(text='Вкл. микрофон', bg='#d0f0d0', activebackground='#b0e0b0')
        else:
            self._btn_mic_mute.config(text='Откл. микрофон', bg='#ffe0e0', activebackground='#ffc0c0')
    ...
    def _start(self):
        ...
        self._btn_mic_mute.config(state='normal', text='Откл. микрофон', bg='#ffe0e0', activebackground='#ffc0c0')
    ...
    def _on_stopped(self, files: list[str]):
        ...
        self._btn_mic_mute.config(state='disabled', text='Откл. микрофон', bg='#ffe0e0', activebackground='#ffc0c0')
    ...
    def _cb_levels(self, mic_rms: float, sys_rms: float):
        def _upd():
            muted = bool(self._recorder and self._recorder._mic_muted)
